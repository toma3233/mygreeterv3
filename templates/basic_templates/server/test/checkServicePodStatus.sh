...
NAMESPACES=("<<.sharedInput.productShortName>>-<<.serviceInput.directoryName>>-server" "<<.sharedInput.productShortName>>-<<.serviceInput.directoryName>>-client" "<<.sharedInput.productShortName>>-<<.serviceInput.directoryName>>-demoserver")
