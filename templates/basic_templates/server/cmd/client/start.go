...
func SayHello(client pb.<<.serviceInput.serviceName>>Client, name string, age int32, email string, address string, logger *log.Logger) {
	...
	_, _, err = service.<<.serviceInput.serviceName>>SayHello(context.TODO(), sayHelloRequest)
	if err != nil {
