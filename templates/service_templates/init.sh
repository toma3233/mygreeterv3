...
go mod edit -require <<apiModule .envInformation.goModuleNamePrefix .serviceInput.directoryName>>@v0.0.83<<end>>
<<- if (contains .envInformation.goModuleNamePrefix "service_hub")>>
go mod edit -require <<apiModule .envInformation.goModuleNamePrefix .serviceInput.directoryName>>@v0.0.9<<end>>
<<- if (contains .envInformation.goModuleNamePrefix "temp_userenv")>>
go mod edit -require <<apiModule .envInformation.goModuleNamePrefix .serviceInput.directoryName>>@v0.0.17<<end>>
go mod edit -require github.com/Azure/aks-middleware@v0.0.23
go get google.golang.org/genproto@latest
go mod tidy
