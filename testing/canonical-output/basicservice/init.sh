...
# For the api.
cd api
go mod init dev.azure.com/service-hub-flg/service_hub/_git/service_hub.git/testing/canonical-output/basicservice/api
...
# For the server
cd server
go mod init dev.azure.com/service-hub-flg/service_hub/_git/service_hub.git/testing/canonical-output/basicservice/server
go mod edit -require dev.azure.com/service-hub-flg/service_hub/_git/service_hub.git/testing/canonical-output/basicservice/api@v0.0.7
go mod edit -require github.com/Azure/aks-middleware@v0.0.23
go mod tidy
