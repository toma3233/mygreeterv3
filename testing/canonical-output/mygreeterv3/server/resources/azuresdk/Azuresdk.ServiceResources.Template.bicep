...
module managedIdentity 'br/public:avm/res/managed-identity/user-assigned-identity:0.2.1' = {
  name: 'servicehub-${resourcesName}-mygreeterv3-managed-identityDeploy'
  scope: resourceGroup(subscriptionId, resourceGroupName)
  params: {
    ...
    name: 'servicehub-${resourcesName}-mygreeterv3-managedIdentity'
    location: rg.location
    federatedIdentityCredentials: [
      {
        name: 'servicehub-${resourcesName}-mygreeterv3-fedIdentity'
